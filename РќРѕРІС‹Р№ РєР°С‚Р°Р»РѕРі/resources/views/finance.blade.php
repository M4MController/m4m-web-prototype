									...
									<div class="tabs">
										<div class="tabs_block tabs_block_js tabs_block_row">
											<ul class="tabs tabs_col">
												<li class="tabs__item tabs__item_col font-weight-bold "><span>Дом у дороги</span></li>
											...
											<div class="box box_js ">
												<div class="finance">
													<div class="finance__title d-flex justify-content-between align-items-center">
														...
														<div>
															<button class="btn btnStyle btnStyle_сolorless"><span class="icon-disabled"></span> История платежей</button>
														</div>
													</div>
											...
											<div class="box box_js visible">
												<div class="financeArchive">
													<div class="d-flex justify-content-between align-items-center">
														<h4 class="font-weight-bold">Статистика платежей</h4>
														
														<button class="btn btnStyle btnStyle_сolorless financeSmallerBasicText"><span class="icon-disabled"></span> Вернуться к оплате</button>
													</div>
													<div class="d-flex justify-content-between align-items-center">
														<div>
